...
What came out of that process was not some magical fully formed method, but a few plausible directions that the models could already expand from surprisingly small prompts. Here is roughly the level of suggestion I was giving them:
